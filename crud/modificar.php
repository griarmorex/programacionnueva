...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8">
			...
			<input type="hidden" class="form-control" name="txt-id" id="txt-id" placeholder="Apellido Materno" value="<?php echo$fila['persona_id'];?>">
				<div class="form-group">
					<label for="txt-paterno" class="col-md-2 control-label">Paterno:</label>
					<div class="col-md-2">
						<input type="text" class="form-control" name="txt-paterno" id="txt-paterno" placeholder="Apellido Materno" value="<?php echo$fila['paterno'];?>">
					</div>		
				</div>
				<div class="form-group">
